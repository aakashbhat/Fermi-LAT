...
and the rest 346 sources are OTHER sources, such as pulsar wind nebulas (PWNs)%\LEt{ Please define.}
...
In this subsection we determined the numbers of AGNs, PSRs, and, in case of three-class classification, OTHER sources as a function of their flux.
