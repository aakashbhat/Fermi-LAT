...
%We find the accuracy of classification to be about 94\% -- 97\% (96\% -- 98\% ) by splitting associated 3FGL (4FGL-DR2) sources into training and testing samples.
...
We find that most of unassociated sources are likely AGNs, while the expected number of pulsars among unassociated sources in the 3FGL (4FGL-DR2) catalog is $262 \pm 101$ ($457 \pm 200$), i.e., the total number of pulsars is expected to be about two times larger than the number of associated pulsars: 167 (271) in the 3FGL (4FGL-DR2) catalogs.
\dima{update numbers of pulsars}
}
