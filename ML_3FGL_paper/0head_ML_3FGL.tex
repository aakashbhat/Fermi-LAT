...
We find the accuracy of classification to be 95\% by splitting associated sources into training and testing samples.
...
We find that most of unassociated sources are likely AGNs, while the total expected number of pulsars is about two times larger than the number of associated pulsars.
}
