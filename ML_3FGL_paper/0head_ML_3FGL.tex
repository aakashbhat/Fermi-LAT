...
{
We determine probabilistic classification of both associated and sources in 3FGL and 4FGL-DR2 catalogs.
...
%In particular, the number of pulsars among unassociated sources estimated by summing the pulsar-like probabilities  in the 3FGL (4FGL-DR2) catalog is  $270^{+98}_{-76}$ ($483^{+245}_{-174}$) in the 2-class case without corrections for the other sources and $158^{+22}_{-24}$  ($215^{+47}_{-42}$) in the 3-class case.
%Provided that the number of associated pulsars is 167 (271) in the 3FGL (4FGL-DR2) catalog, the number of pulsars among the unassociated sources is expected to be similar or larger than the number of associated ones. 
We show an example of the use of the probabilistic catalogs for populations studies, which include both associated and 
