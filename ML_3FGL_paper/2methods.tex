...
The importance of features for the case of two different RF algorithms: 20 trees with maximum depth of 2 and 50 trees with maximum depth of 6 are shown in Table \ref{tab:feat_imp}.
We find that the three most important features for both cases are significance of curvature, hardness ratio of the last two energy bins, and uncertainty of the energy flux at 100 MeV.
...
\hline
{ $\ln$(Signif\_Curve)}&  0.367  &  0.331  \\
{ HR45}&0.149&0.137\\
{ $\ln$(Unc\_Energy\_Flux100)} & 0.182 &0.122  \\
...
\end{tabular}
\vspace{0.4cm}
\caption{Feature importance for two RF algorithms ordered by decreasing importance 
in the case of 50 trees.
\dima{Should we use BDT with 100 trees and depth 2 instead of RF with 20 trees and depth 2 and move this table to the end of the BDT section?}
}
\label{tab:feat_imp}
\end{table}
