...
%In this section we use the 2-class classification in AGNs and pulsars of the 3FGL catalog sources as an example to show the selection of features and meta-paramters of the algorithms.
...
In Figure \ref{fig:prec_recall} we show precision and recall for classification of pulsars.
