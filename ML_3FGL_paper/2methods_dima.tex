...
The accuracy increases with higher number of epochs and saturates at around 50 for LBFGS and 300 for Adam. LBFGS converges faster than Adam, which uses stochastic gradient descent.
