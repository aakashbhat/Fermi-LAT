...
\begin{figure}[h]
%\hspace*{-1cm}
\includegraphics[width=0.5\textwidth]{plots/classification_domains/rf_50_6_oversample.pdf}
%\hspace*{-1cm}
\includegraphics[width=0.5\textwidth]{plots/classification_domains/rf_50_6_final.pdf}
\caption{Top panel: RF classification domains showing class probabilities for training with oversampling similar to Figure \ref{fig:RF_domains}.
...
Bottom panel: we repeat the bottom panel of Figure \ref{fig:RF_domains} for convenience.
}  
\label{fig:RF_domains_O}
\end{figure}
