...
%\hspace*{-1cm}
\includegraphics[width=0.5\textwidth]{plots/classification_domains/lr_200_lbfgs.pdf}
\caption{Top panel: LR classification domains showing class probabilities for training with oversampling similar to Figure \ref{fig:LR_domains}.
...
Bottom panel: we repeat the bottom panel of Figure \ref{fig:LR_domains} for convenience.
}  
