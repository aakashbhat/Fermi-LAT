...
For the final algorithm, we use a RF with 20 trees and a maximum depth of 12 trained on inversely weighted data. For the objective function we chose the gini index, which uses the square of the class probabililties for minimization.\\
