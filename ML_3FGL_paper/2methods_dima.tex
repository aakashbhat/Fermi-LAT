...
\dima{Most of domain plots (also below) still have a lot of white space around them. May I ask you to check and push the new versions?}
}  
...
%\centerin
\hspace*{-1cm}
\includegraphics[width=0.5\textwidth]{plots/bdt_20_2.pdf}
\hspace*{-1cm}
\includegraphics[width=0.5\textwidth]{plots/bdt_100_6.pdf}
