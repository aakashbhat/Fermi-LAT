...
We use the associated sources which were classified as either AGNs (agn, FSRQ, fsrq, BLL, bll, BCU, bcu, RDG, rdg, NLSY1, nlsy1, ssrq, and sey) or Pulsars (PSR, psr). 
...
In the case of test data, we worked with all the different classification algortithms, namely Random Forests, Ada Boost, logistic regression, and Neural Networks. Here we were mostly concerned with tweaking the parameters of the classification algorithms involved, minimizing the cost of computation and aiming for the most efficient way of classification. \\
...
\begin{figure}[h]
%\centering
\includegraphics[width=\twopicsp\textwidth]{plots/20trees_md_weighted} \\
