...
This problem can be ameliorated by giving larger weights to pulsars in the training process or by oversampling, i.e., by using the same source several times, so that the numbers of pulsars and AGNs in training are the same.
