...
The accuracy of our prediction for the four selected algorithms \dima{(both with and without oversampling)}, taking the 4FGL classes as the true values, is reported in the column ``Accuracy from Comparison with 4FGL''.
