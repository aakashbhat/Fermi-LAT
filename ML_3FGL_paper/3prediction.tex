...
\renewcommand{\arraystretch}{1.5}
    ...
    \hline
    Algorithm&Parameters & Testing Accuracy & Comparison with 4FGL data \\
    \hline
    RF& 50 trees, max depth 6  &97.69& 95.32  \\
    \hline
    NN & 300, 10 Neurons, Adam & 97.40& 95.56 \\
    \hline %\midrule   -> aakash do you mean this?
    BDT & 100 trees, max depth 2    &   97.80&95.86 \\
%    \hline %\midrule   -> aakash do you mean this?
%    BDT & 200 trees, max depth 2    &   95.8  \\
    \hline
    LR & LBFGS solver, 200 iterations & 97.60&87.14 (balanced), 95.08 \\
    \hline
...
Here we discuss the results of our probabilistic classification on the unassociated data. The 242 sources for whom FGL counterparts existed were plotted in figure 10. This figure shows all AGNs and PSRs, including those which were correctly identified by all the 4 algorithms (given by keyword classified) and those which were misclassified by all 4 algorithms (given by keyword misclassified). 
\begin{figure*}[h]
\centering
