...
The correct classifications and misclassifications for the 303 sources with PSR or AGN associations in 4FGL-DR2 are also presented in Fig. \ref{fig:3FGL_vs_4FGL_classes} and in Table \ref{tab:3FGL_vs_4FGL_2class}.
