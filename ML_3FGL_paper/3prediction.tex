...
\renewcommand{\arraystretch}{1.5}
    ...
    \hline
    \hline
    4FGL-DR2 class & \multicolumn{3}{c}{3FGL prediction} \ &  Recall\ \ & Recall\\
      &\ AGN &\ PSR &\ MIXED & & (test)\\
    \hline
    AGN & 223 & 5 &  30 & 0.86 & 0.00 \\ % 258
    PSR & 10 & 23 &  12  & 0.51 & 0.00 \\ % 45
    OTHER & 8 & 6 & 23  & -- & -- \\ % 37
    \hline
    Precision & 0.93 & 0.68 & --  \\
    Precision (test) & 0.00 & 0.00 & --  \\
    \hline
    \end{tabular}}
    \vspace{2mm}
    \caption{Including precision and recall.
...
{\bf The classes of sources reported in this work derived from the class probabilities should be viewed as candidate classes.
