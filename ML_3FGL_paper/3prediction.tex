...
This is further illustrated by the estimated precision for AGNs (pulsars) using either ``all-agree'' or $\sum_a p_a > 7$ condition. The precision estimates from the comparison of 3FGL and 4FGL-DR2 catalogs is about 93\% (70\%) for AGNs (pulsars), which is lower than the 97\% (80\%) testing precision with the 2-class classification.
We will see in Section \ref{sec:3class} that a similar result holds for the expected precision using  either ``all-agree'' or $\sum_a p_a > 7$ condition for the 3-class classification for AGNs (pulsars). The estimate from the comparison of 3FGL and 4FGL-DR2 catalogs is still about 93\% (70\%), lower than the 99\% (90\%) testing precision .
Thus even if the expected test precision is better in the 3-class case than in the 2-class case, the precision estimates from the comparison of 3FGL and 4FGL-DR2 catalogs are similar in the 2- and 3-class cases.
