...
The 4FGL-DR2 catalog has higher number of features, especially due to the difference in modeling of the spectra compared with the 3FGL catalog. 
We selected 28 of these features and looked for correlations among them. We looked for correlations between these features similar to the correlation done for 3FGL. 

Finally, we chose 10 features from the catalog:
...
In addition similar to the classification of the 3FGL sources, we added 6 hardness ratios to the list of features:
hr12, hr23, hr34, hr45, hr56, hr67 (in the 4FGL-DR2 catalog there are two more energy bins compared to the 3FGL catalog). The correlation of these with the rest 10 features was also found to be lower than $\pm 0.75$ for all of the hardness ratios.
