...
\begin{comment}
while the 
In particular, the expected number of pulsars
...
The numbers of PSRs and OTHER sources in the 3-class classification as a function of flux are shown in Figure \ref{fig:logN_logS_3classes}.
