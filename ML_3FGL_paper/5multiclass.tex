...
\end{enumerate}
We have saved this candidate list with the rest of the catalogs. Furthermore, there are 6 PSR candidates in our multi-class classification with a probability sum $\text{PSR\_TOTAL}> 7.0$. These are the sources: 4FGL J1225.9+2951, 4FGL J2112.5-3043, 4FGL J1120.0-2204, 4FGL J0933.8-6232, 4FGL J0953.6-1509, 4FGL J1539.4-3323. All of these sources are also predicted to be pulsars as part of our 29 PSR sources mentioned in section 4 (using both 4FGL and 3FGL features). 