...
In the paper we determine the probabilities of classification of unassociated sources in the 3FGL and 4FGL-DR2 \Fermi-LAT catalogs
...
The accuracies, which we obtained for the 3FGL catalog for the four algorithms without oversampling in the 2-class case are about 97\%, with oversampling the accuracies are between 93\% and 97\%.
...
with (without) oversampling are between 89\% and 91\% (85\% and 91\%).
