...
\dima{I suggest to remove ``Accuracy vs. Regularization'' from the title, since this is shown on the axes labels.}
}
...
\dima{I suggest to put ``2 Hidden Layers'' in the title to parentheses in order to make it consistent with the LR plot above and other 
plots in the paper.}
}
\label{fig:nn_nn}
\end{figure}
