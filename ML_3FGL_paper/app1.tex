...
\end{tabular}
\vspace{2mm}
\caption{The Parameters of histograms for the 4 algorithms used in 3FGL with PSR-like probabilities for all sources
}
\label{tab:compO}
\end{table}
...
Since Logistic Regression was used also to compare the domains, we plot the Histograms of the probability difference here for both 3FGL and 4FGL-DR2 data.
\begin{figure}[h]
\centering
\hspace*{-0.5cm}
