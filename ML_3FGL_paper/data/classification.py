...
classifiers = [RandomForestClassifier(max_depth=12, n_estimators=200, class_weight='balanced',oob_score=True),
...
#clf= MLPClassifier(max_iter=300,hidden_layer_sizes=(20,5,), activation='tanh', solver='adam',batch_size=1000).fit(X_train,y_train)
