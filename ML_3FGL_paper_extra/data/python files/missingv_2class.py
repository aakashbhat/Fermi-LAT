...
dataframe = pandas.read_csv("./files/4fgldr2_missingvals.csv", header=None)
dataset1 = dataframe.values
lenth=17

unassocnames=dataset1[1:,0]
l=dataset1[1:,1].astype(float)
dataset1[1:,1]=np.cos(l)
...
while se<times:
    ...
    #X_over=train1
    #y_over=train_truth1
    oversample = SMOTE()#sampling_strategy=weight)
...
result.to_csv(path_or_buf="./catas/try_4fgldr2_missingv_2class_SMOTE.csv",index=False)
